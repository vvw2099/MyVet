...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        {
            await _dataContext.Database.EnsureCreatedAsync();  //verifica si la base de datos esta creada
            await CheckRoles();
            var manager = await CheckUserAsync("1010","Juan","Zuluaga","jzuluaga55@gmail.com","350 987 2747","Calle de la Betty","Admin");
            var customer = await CheckUserAsync("2020","Juan", "Zuluaga","jzuluaga55@hotmail.com", "350 987 2747", "Calle de la Betty","Customer");
            ...
            string phone,string address,string role )
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.ComfirmEmailAsync(user, token);
            }
            return user;
        }
