    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            var owner = await _dataContext.Owners
                .FirstOrDefaultAsync(o => o.user.Email.ToLower() == User.Identity.Name.ToLower());
            if(owner == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> MyAgenda()
        {
            ...
            list.Where(a => a.Owner != null && a.Owner.user.UserName.ToLower() == User.Identity.Name.ToLower())
        ...
        public async Task<IActionResult> Assing(int? id)
        {
            ...
            var owner = await _dataContext.Owners.FirstOrDefaultAsync(o => o.user.UserName.ToLower()
